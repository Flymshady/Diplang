...
public class Page6Lesson1Fragment extends Fragment implements View.OnClickListener {
    ...
    private void loadData() {
        DatabaseReference myRefPage = database.getReference("Lessons").child("Lesson1").child("Page6").child("PageParams");
    ...
    private int calculatePoint() {
        ...
        ET1L1P6.setFocusableInTouchMode(false);
        ET2L1P6.setFocusableInTouchMode(false);
        ET3L1P6.setFocusableInTouchMode(false);
        ET4L1P6.setFocusableInTouchMode(false);
        ET5L1P6.setFocusableInTouchMode(false);
        ET1L1P6.setFocusable(false);
        ET2L1P6.setFocusable(false);
        ET3L1P6.setFocusable(false);
        ET4L1P6.setFocusable(false);
        ET5L1P6.setFocusable(false);
