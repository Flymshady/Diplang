...
public class Page3Lesson3Fragment extends Fragment implements View.OnClickListener {

    private Button btnNextToP4L3;
    private ViewPager2 viewPager2;
    private LinearLayout linearLayout;
    private TextView infoPage3Lesson3;
    private TheoryTask theoryTask1, theoryTask2, theoryTask3;
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    private LessonPage lessonPage;

    public Page3Lesson3Fragment() {
        // Required empty public constructor
    }


    public static Page3Lesson3Fragment newInstance(String param1, String param2) {
        Page3Lesson3Fragment fragment = new Page3Lesson3Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_page3_lesson3, container, false);

        linearLayout = (LinearLayout) v.findViewById(R.id.layoutP3L3);

        loadData();

        infoPage3Lesson3 = (TextView) v.findViewById(R.id.infoPage3Lesson3);
        btnNextToP4L3 = (Button) v.findViewById(R.id.btnNextToP4L3);
        btnNextToP4L3.setOnClickListener(this);
    ...
    private void loadData() {
        ...
        DatabaseReference myRefPage = database.getReference("Lessons").child("Lesson3").child("Page3");
        myRefPage.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(lessonPage!=null){
                    infoPage3Lesson3.setText(lessonPage.getInfo());
                }
            }
            @Override
