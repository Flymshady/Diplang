 ...
 * Fragment třetí stránky, první lekce, úrovně B2
 */
public class Page3Lesson1Fragment extends Fragment implements View.OnClickListener {
    ...
    private int calculatePoint() {
        ...
        ET1L1P3.setFocusableInTouchMode(false);
        ET2L1P3.setFocusableInTouchMode(false);
        ET3L1P3.setFocusableInTouchMode(false);
        ET4L1P3.setFocusableInTouchMode(false);
        ET5L1P3.setFocusableInTouchMode(false);
        ET6L1P3.setFocusableInTouchMode(false);
        ET1L1P3.setFocusable(false);
        ET2L1P3.setFocusable(false);
        ET3L1P3.setFocusable(false);
        ET4L1P3.setFocusable(false);
        ET5L1P3.setFocusable(false);
        ET6L1P3.setFocusable(false);
